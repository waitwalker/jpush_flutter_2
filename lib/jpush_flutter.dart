...
class JPush {
  ...
  Future<Null> _handleMethod(MethodCall call) async {
    ...
    switch (call.method) {
      case "onReceiveNotification":
        return _onReceiveNotification!(call.arguments.cast<String, dynamic>()) as FutureOr<Null>;
      case "onOpenNotification":
        return _onOpenNotification!(call.arguments.cast<String, dynamic>()) as FutureOr<Null>;
      case "onReceiveMessage":
        return _onReceiveMessage!(call.arguments.cast<String, dynamic>()) as FutureOr<Null>;
      case "onReceiveNotificationAuthorization":
        return _onReceiveNotificationAuthorization!(call.arguments.cast<String, dynamic>()) as FutureOr<Null>;
      default:
  ...
  Future<bool?> isNotificationEnabled() async {
    final Map<dynamic, dynamic> result = await (_channel.invokeMethod('isNotificationEnabled') as FutureOr<Map<dynamic, dynamic>>);
